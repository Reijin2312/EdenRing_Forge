...
public class EdenBlocks {
	...
	static {
		...
		for (int i = 0; i < 16; i++) {
			...
			Block lantern = register(
				...
				new BaseBlock(BlockBehaviour.Properties.copy(Blocks.MUSHROOM_STEM).sound(SoundType.WOOL))
			);
	...
	public static final Block ALAESPES_SMALL = registerBlockOnly("alaespes_small", new AlaespesSmallBlock());
	...
	//public static final Block INSULECTRICA_STEM = register("insulectrica_stem", new BaseBlock(BlockBehaviour.Properties.copy(Blocks.STONE)));
	//public static final Block INSULECTRICA_ROD = register("insulectrica_rod", new BaseBlock(BlockBehaviour.Properties.copy(Blocks.STONE)));
