...
public class EdenFeatures {
	...
	public static final BCLFeature<ScatterFeature, NoneFeatureConfiguration> AZALEA_RARE = registerChanced("azalea_rare", Decoration.VEGETAL_DECORATION, inlineBuild("azalea_rare", new ScatterFeature(Blocks.AZALEA, 2)), NoneFeatureConfiguration.NONE, 14);
	public static final BCLFeature<ScatterFeature, NoneFeatureConfiguration> FLOWERING_AZALEA_RARE = registerChanced("flowering_azalea_rare", Decoration.VEGETAL_DECORATION, inlineBuild("flowering_azalea_rare", new ScatterFeature(Blocks.FLOWERING_AZALEA, 2)), NoneFeatureConfiguration.NONE, 18);
	...
	public static final BCLFeature<ScatterFeature, NoneFeatureConfiguration> ALAESPES_SMALL = registerVegetation("alaespes_small", inlineBuild("alaespes_small", new ScatterFeature(EdenBlocks.ALAESPES_SMALL, 3)), 1);
	public static final BCLFeature<DoubleScatterFeature, NoneFeatureConfiguration> ALAESPES = registerVegetation("alaespes", inlineBuild("alaespes", new DoubleScatterFeature(EdenBlocks.ALAESPES, 2)), 1);
	...
	public static final BCLFeature<GraviliteDebrisFeature, NoneFeatureConfiguration> GRAVILITE_DEBRIS = registerChanced("gravilite_debris", inlineBuild("gravilite_debris", new GraviliteDebrisFeature()), NoneFeatureConfiguration.NONE, 2);
